...
$Config = @{
    ...
    DriveRoot ='C:'
    FolderInstall = 'Tools'
    FileInstall = 'LibreOffice_7.4.7_Win_x64.msi'
    FileArguments = ("/i c:\Tools\LibreOffice_7.3.7_Win_x64.msi", "/quiet")
    RootKey = 'HKLM:\Software\ManutTools\LibreOffice'
    KeyName = '7.4.7'
    UrlDownloadInstall = 'https://download.documentfoundation.org/libreoffice/stable/7.4.7/win/x86_64/LibreOffice_7.4.7_Win_x64.msi'
    UrlDownloadRemoval = ''
}
...
If( $command -eq $false ) { Write-Host "Comando => .\LibreOfficeTools.ps1 [ install | download ] " }
